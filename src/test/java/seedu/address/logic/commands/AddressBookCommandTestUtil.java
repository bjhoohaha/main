...
public class AddressBookCommandTestUtil {
     ...
     */
    public static void assertCommandSuccess(AddressBookCommand command, Model actualModel,
     ...
     */
    public static void assertCommandSuccess(AddressBookCommand command, Model actualModel, String expectedMessage,
            Model expectedModel) {
     ...
     */
    public static void assertCommandFailure(AddressBookCommand command, Model actualModel, String expectedMessage) {
