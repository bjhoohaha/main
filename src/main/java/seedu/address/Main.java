 ...
 *
 * This is a workaround for the following error when MainAddressBookApp is made the
 * entry point of the application:
 *
 *     Error: JavaFX runtime components are missing, and are required to run this application
 *
 * The reason is that MainAddressBookApp extends Application. In that case, the
...
public class Main {
    public static void main(String[] args) {
        Application.launch(MainAddressBookApp.class, args);
    }
}
